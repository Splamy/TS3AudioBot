...
namespace TS3Client.Full
{
	...
	public sealed class VersionSign
	{
		...
		public static VersionSign VER_WIN_3_2_2 { get; } = new VersionSign("3.2.2 [Build: 1535010838]", ClientPlatform.Windows, "ZUdctNEUa/SrRrXbqFCESmKIVDJj0nJrO0vwvxDNJGB/p65vf5GqvX9p625FOXO50dxxHPIIAvJDEjM/TxeuBg==");
		public static VersionSign VER_OSX_3_2_2 { get; } = new VersionSign("3.2.2 [Build: 1535010838]", ClientPlatform.Osx, "qvbU2yq0wzSxPLPClraVmriM1Z+yB9qq5UzQ+gxuwE6dG8k/eosJH9xBhL7bhgcJKRgY2vsL00vbiLk19c+rBA==");
		public static VersionSign VER_LIN_3_2_2 { get; } = new VersionSign("3.2.2 [Build: 1535010838]", ClientPlatform.Linux, "7uY1DWoJD2x80002ha6jSkNRXGcfHAqS9hdJz80JjafvhmxlhQKSwfsofFjEq10TI8LFbhLdv7TQxd+gPyNEAg==");
