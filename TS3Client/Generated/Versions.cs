...
namespace TS3Client.Full
{
	...
	public sealed class VersionSign
	{
		...
		public static VersionSign VER_MAC_5_0_0 { get; } = new VersionSign("5.0.0-alpha353 [Build: 1568828473]", "macOS", ClientPlatform.MacOs, "F+3xGce0D7mujDxL179YtEhO61SY6iqu5Fa2bKhWRY9C/cUGGSXDNKrn4A1fe5M8NkJDH2HsnuNCSQHssQnlCw==");
		public static VersionSign VER_WIN_5_0_0 { get; } = new VersionSign("5.0.0-alpha352 [Build: 1568742967]", "Windows", ClientPlatform.Windows, "rVdkwzZbfhuqxr8XrVT07NmI7KWh9yuKukRAeeVnA6TSiZlnDzVpKsFeZ+XRvQqlg9f6NQjM6mOGJFd4Z/TwBw==");
		...
		public static VersionSign VER_MAC_3_5_0 { get; } = new VersionSign("3.5.0 [Build: 1567775523]", "OS X", ClientPlatform.MacOs, "d5asvnlZOJucbg1E3A2JUJ2IrxJ0Q4pJlrMwvZhsvxTK5D2dW4TUJIcQmDnndgC4FKrk//VMHsnrtFIfhhrCCQ==");
