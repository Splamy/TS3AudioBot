...
namespace TS3Client.Full
{
	...
	public sealed class VersionSign
	{
		...
		public static VersionSign VER_WIN_3_2_0 { get; } = new VersionSign("3.2.0 [Build: 1530183207]", ClientPlattform.Windows, "6LYlvxFIPCVnYmmFd64H8SRmxsX+y3IZOe9ju8PbZLI5j2K7ni6Z0BfEyhVprYP9VA5o4bXVrV+uNbdGSKnjCQ==");
		public static VersionSign VER_WIN_3_1_10 { get; } = new VersionSign("3.1.10 [Build: 1528537615]", ClientPlattform.Windows, "+/BWvueikGg4YkO1v2uuZB5vtJJgUZ5bL8cRfxAstfnCVdro2ja+4a+8rGUzDx8/vvTZOUVD6U95hnWb638MCQ==");
		public static VersionSign VER_LIN_3_1_10 { get; } = new VersionSign("3.1.10 [Build: 1528537615]", ClientPlattform.Linux, "jEfjYy09JfbJPZ+W3fwqygOu8uuc5raYTGpbJ5F8dHLHpqUfvmCyJVKoXRieMNkmPzeiylsUc9/HiV+8bt8tDw==");
		...
		public static VersionSign VER_LIN_3_1_9 { get; } = new VersionSign("3.1.9 [Build: 1525442084]", ClientPlattform.Linux, "wBcnfNU7FA0CvFeisKhywZWzmUqD6IBFbYQTveMvxWowXUjWwNHTg9tbRLQ1YgBFDdlOwV36VMX7aAMXMX2rAA==");
		public static VersionSign VER_AND_3_1_8 { get; } = new VersionSign("3.1.8 [Build: 1516865456]", ClientPlattform.Android, "sG/qsKb9iZpBRXFSYY2Tuq7ZLUKHcmgA/6Qe/cx35L3risqoH4aGkPkDicuKtaQi8Ikh4IrQz6xe7V49M+8VBg==");
		public static VersionSign VER_IOS_3_1_8 { get; } = new VersionSign("3.1.8 [Build: 1516887927]", ClientPlattform.Ios, "pdWyIOpTWECIdA2NExrjqY1a7Q0alFyU7MgiDJYdiUXAspusOHwMIcfKm7oAh+Ty2gcgVgOh8wAPyZcKFKYXBA==");
