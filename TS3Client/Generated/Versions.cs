...
namespace TS3Client.Full
{
	...
	public sealed class VersionSign
	{
		...
		public static VersionSign VER_WIN_5_0_0 { get; } = new VersionSign("5.0.0-test.1 [Build: 1572609725]", "Windows", ClientPlatform.Windows, "MJvx4bAduHXmC1AAX+w6Lv4vHAUatzBXfKhtJIV9SDKd/q98BIJWEkGCuBXEdBzk9VXfcTpLUefz47BPSQ8RCA==");
		public static VersionSign VER_MAC_5_0_0 { get; } = new VersionSign("5.0.0-test.1 [Build: 1572609725]", "macOS", ClientPlatform.MacOs, "axyql5RDoqUxtZkbPY+Jw7uJgd0n/Rz8LeBbdu+Tj6mW3A0U0u+wPpc7qg2OWA5dRHQ0Ut+VF9okXbsI5PKwDA==");
