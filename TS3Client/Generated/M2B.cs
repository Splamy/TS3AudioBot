...
#pragma warning disable IDE0017 // Ignore "Object initialization can be simplified"
		public void Update(LazyNotification notification)
		{
			switch(notification.NotifyType)
			{
				
				case NotificationType.InitServer: {
					foreach(var msg in notification.Notifications.Cast<InitServer>())
					{
					var obj = new Server();
				...
				case NotificationType.ChannelCreated: {
					foreach(var msg in notification.Notifications.Cast<ChannelCreated>())
					{
					var obj = new Channel();
				...
				case NotificationType.ChannelDeleted: {
					foreach(var msg in notification.Notifications.Cast<ChannelDeleted>())
					{
				...
				case NotificationType.ChannelEdited: {
					foreach(var msg in notification.Notifications.Cast<ChannelEdited>())
					{
				...
				case NotificationType.ChannelList: {
					foreach(var msg in notification.Notifications.Cast<ChannelList>())
					{
					var obj = new Channel();
						obj.Parent = msg.ChannelParentId;
						{
				...
				case NotificationType.ChannelMoved: {
					foreach(var msg in notification.Notifications.Cast<ChannelMoved>())
					{
					var obj = GetChannel(msg.ChannelId);
						obj.Parent = msg.ChannelParentId;
						obj.Order = msg.Order;
				...
				case NotificationType.ClientChannelGroupChanged: {
					foreach(var msg in notification.Notifications.Cast<ClientChannelGroupChanged>())
					{
				...
				case NotificationType.ClientEnterView: {
					foreach(var msg in notification.Notifications.Cast<ClientEnterView>())
					{
					var obj = new Client();
				...
				case NotificationType.ClientLeftView: {
					foreach(var msg in notification.Notifications.Cast<ClientLeftView>())
					{
				...
				case NotificationType.ClientMoved: {
					foreach(var msg in notification.Notifications.Cast<ClientMoved>())
					{
					var obj = GetClient(msg.ClientId);
						obj.Channel = msg.TargetChannelId;
				...
				case NotificationType.ConnectionInfo: {
					foreach(var msg in notification.Notifications.Cast<ConnectionInfo>())
					{
				...
				case NotificationType.ClientServerGroupAdded: {
					foreach(var msg in notification.Notifications.Cast<ClientServerGroupAdded>())
					{
					var obj = GetClient(msg.ClientId);
				...
				case NotificationType.ServerGroupList: {
					foreach(var msg in notification.Notifications.Cast<ServerGroupList>())
					{
				...
				case NotificationType.ServerEdited: {
					foreach(var msg in notification.Notifications.Cast<ServerEdited>())
					{
					var obj = GetServer();
						obj.Name = msg.Name;
						obj.CodecEncryptionMode = msg.CodecEncryptionMode;
