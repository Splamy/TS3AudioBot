...
namespace TS3Client.Commands
{
	partial class Ts3Command
	{
		...
		[DebuggerStepThrough] public Ts3Command Add(string key, Uid? value) { if(value.HasValue) return Add(key, value.Value); return this; }
		[DebuggerStepThrough] public Ts3Command Add(string key, Uid value) => Add(new CommandParameter(key, value));

		[DebuggerStepThrough] public Ts3Command Add(string key, IEnumerable<Uid> value) => Add(new CommandMultiParameter(key, value));

		[DebuggerStepThrough] public Ts3Command Add(string key, ClientDbId? value) { if(value.HasValue) return Add(key, value.Value); return this; }
		[DebuggerStepThrough] public Ts3Command Add(string key, ClientDbId value) => Add(new CommandParameter(key, value));

		[DebuggerStepThrough] public Ts3Command Add(string key, IEnumerable<ClientDbId> value) => Add(new CommandMultiParameter(key, value));

		[DebuggerStepThrough] public Ts3Command Add(string key, ClientId? value) { if(value.HasValue) return Add(key, value.Value); return this; }
		[DebuggerStepThrough] public Ts3Command Add(string key, ClientId value) => Add(new CommandParameter(key, value));

		[DebuggerStepThrough] public Ts3Command Add(string key, IEnumerable<ClientId> value) => Add(new CommandMultiParameter(key, value));

		[DebuggerStepThrough] public Ts3Command Add(string key, ChannelId? value) { if(value.HasValue) return Add(key, value.Value); return this; }
		[DebuggerStepThrough] public Ts3Command Add(string key, ChannelId value) => Add(new CommandParameter(key, value));

		[DebuggerStepThrough] public Ts3Command Add(string key, IEnumerable<ChannelId> value) => Add(new CommandMultiParameter(key, value));

		[DebuggerStepThrough] public Ts3Command Add(string key, ServerGroupId? value) { if(value.HasValue) return Add(key, value.Value); return this; }
		[DebuggerStepThrough] public Ts3Command Add(string key, ServerGroupId value) => Add(new CommandParameter(key, value));

		[DebuggerStepThrough] public Ts3Command Add(string key, IEnumerable<ServerGroupId> value) => Add(new CommandMultiParameter(key, value));

		[DebuggerStepThrough] public Ts3Command Add(string key, ChannelGroupId? value) { if(value.HasValue) return Add(key, value.Value); return this; }
		[DebuggerStepThrough] public Ts3Command Add(string key, ChannelGroupId value) => Add(new CommandParameter(key, value));

		[DebuggerStepThrough] public Ts3Command Add(string key, IEnumerable<ChannelGroupId> value) => Add(new CommandMultiParameter(key, value));
