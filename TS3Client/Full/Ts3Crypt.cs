namespace TS3Client.Full
{
	...
	public sealed class Ts3Crypt
	{
        ...
        /// <summary>
        /// Loads identity data from json string which was previous generated by IdentityData.Tostring
        /// </summary>
        /// <param name="jsonData"></param>
        /// <returns></returns>
        public static IdentityData LoadIdentity(string jsonData)
        {
            var ic = Newtonsoft.Json.JsonConvert.DeserializeObject<IdentityContainer>(jsonData);
            return LoadIdentity(ic.privateKeyString, ic.ValidKeyOffset, ic.lastCheckedKeyOffset);
        }
