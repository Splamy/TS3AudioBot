...
namespace TS3Client.Messages
{
	public partial class CommandError
	{
		...
		public static CommandError Custom(string message) => new CommandError { Id = Ts3ErrorCode.custom_error, Message = message };

		public string ErrorFormat()
		{
			if (MissingPermissionId != Ts3Permission.unknown && MissingPermissionId != Ts3Permission.undefined)
