...
namespace TSLib.Full
{
	...
	public sealed class VersionSign
	{
		...
		public static VersionSign VER_LIN_3_5_0 { get; } = new VersionSign("3.5.0 [Build: 1573741018]", "Linux", ClientPlatform.Linux, "K69Ycxkm2mMkmnx2Z3H/tcexuwhxUCKdCf2HR+2ZYUysEssCI/xCMV5IyVeNtseX/Rj2rKFyU202XvtZvwuHAQ==");
		public static VersionSign VER_MAC_5_0_0 { get; } = new VersionSign("5.0.0-beta.16 [Build: 1573593194]", "macOS", ClientPlatform.MacOs, "FdJ/YMChBoySv+ylNpmi8IFyh933MNTw51ymfks8BiVoAkEn2v9ieBLlApm/2XhhvWbe4TQdd/STu3SeEMepAA==");
		public static VersionSign VER_LIN_5_0_0 { get; } = new VersionSign("5.0.0-beta.16 [Build: 1573593194]", "Linux", ClientPlatform.Linux, "vrwdwFiG2FGhjkfzAS08poN7aU6Y+JT8XQODY4z9QauNe5FWVQlQBCasZe161c0vlEw5CEtN4ObnYu7BtAHRAA==");
		public static VersionSign VER_WIN_5_0_0 { get; } = new VersionSign("5.0.0-test.17 [Build: 1573581231]", "Windows", ClientPlatform.Windows, "FbaymngIJXw8PmYIM0AeSyK/589RSgjoc8J4/fN2pdKL0J1W+LKHq0NIOY9CkltrDASyHMOTLU2XAk6iZj6gCw==");
