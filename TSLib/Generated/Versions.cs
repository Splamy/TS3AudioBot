...
namespace TSLib.Full
{
	...
	public sealed class VersionSign
	{
		...
		public static VersionSign VER_WIN_3_5_3 { get; } = new VersionSign("3.5.3 [Build: 1586353391]", "Windows", ClientPlatform.Windows, "knmVmUvvQTTfOUCWlQncjWFWHXFqZMntUbIPIi/YLcxdW4iP3woJQgVTaIZPEiluMT5A7tb2lSk/r+Byh5R6Dw==");
		public static VersionSign VER_WIN_5_0_0 { get; } = new VersionSign("5.0.0-test.104 [Build: 1586348340]", "Windows", ClientPlatform.Windows, "h/lwYRBPj+GeQZqUNyXOOvVfWlue4rr9FfGgHt7vMlPWCddPH2fNjDf9K7dNGoXMm5DDdVHUfPgcKfC6+nBWBw==");
		public static VersionSign VER_MAC_5_0_0 { get; } = new VersionSign("5.0.0-test.104 [Build: 1586348340]", "macOS", ClientPlatform.MacOs, "O29jwgoTOWgTnZYjhQobrMh607sddxbOlesu8xBU1oMtm74mLZ65dajvMJPb20jpsXhdCqk+KHt8TcMvNx5fDQ==");
		public static VersionSign VER_MAC_3_5_3 { get; } = new VersionSign("3.5.3 [Build: 1586172156]", "OS X", ClientPlatform.MacOs, "8+NprKwynOC+wGqVZnaYc5g2A31f9MdoChKK3RYKd19lZEVRZngk5FFB1lIyI9TQKdNC4opfhGL3dvu9bAtEDw==");
		public static VersionSign VER_LIN_3_5_3 { get; } = new VersionSign("3.5.3 [Build: 1586172156]", "Linux", ClientPlatform.Linux, "GRdePYP+MJpGf6wtKmB2CEMZJ2x1wJLIX81CKqr9mVUDWyp8LTBzOJYxaldUboH+UGh2LOByHNR5EpHA3gdNCw==");
		public static VersionSign VER_WIN_3_5_2 { get; } = new VersionSign("3.5.2 [Build: 1585812952]", "Windows", ClientPlatform.Windows, "6HIIG9j6bIUavbDFJR50Hk3hwl1j4BL/1hQS5Q4JfAS0oerwLNBbdAfXM963aOlE8yan9d/LWiXnuSKhQXAKAQ==");
		public static VersionSign VER_MAC_3_5_2 { get; } = new VersionSign("3.5.2 [Build: 1585812952]", "OS X", ClientPlatform.MacOs, "VhEA3HpeSCbV06Dfh5wonQ+XMuC8dG96ZXvU5HCNLvkSatAfOsDGLaQNLfbkVZVcs0Hvf9oPFgWvAseSX96rCw==");
		public static VersionSign VER_LIN_3_5_2 { get; } = new VersionSign("3.5.2 [Build: 1585812952]", "Linux", ClientPlatform.Linux, "Fy5GNeXUzrP5chKDWhG4G7T3jj8tjg0JkoTNRl+tgrONOWNbNf1zBD+I2LNqJREJXvaSrXcMB1pOQQrWKIXqDQ==");
		public static VersionSign VER_WIN_3_5_1 { get; } = new VersionSign("3.5.1 [Build: 1584955996]", "Windows", ClientPlatform.Windows, "LY20d0yqDFwknHND8FYADnvsKnq81kya6lAEnJEQ+87oN0k8KqTXMDpy/0z0yC54+B8Mo/P8kSjrpRugaVAPDA==");
		public static VersionSign VER_MAC_3_5_1 { get; } = new VersionSign("3.5.1 [Build: 1584955996]", "OS X", ClientPlatform.MacOs, "xk8NdgtqWPihDy1gUPGVtcLkfrl5Fd2lfigB0N7d9K0VGyCxC4ZvQOdX6kM/StTX1xulCnENp0wb+gqwjO5nBA==");
		public static VersionSign VER_LIN_3_5_1 { get; } = new VersionSign("3.5.1 [Build: 1584955996]", "Linux", ClientPlatform.Linux, "YtR6uJ0zzFwlAXoV1ikV8DVD9y7ka0WCh46wvALArdCBw9zaBLE7ese6Uu3U2Dmg4//ook5cNvupeOlzHcGPDQ==");
		public static VersionSign VER_LIN_5_0_0 { get; } = new VersionSign("5.0.0-beta.24 [Build: 1584621089]", "Linux", ClientPlatform.Linux, "iTRafOxViAWbIg4Uc2je7KrxkNTdc8WjEtQvceCAsvPY/wL1tgd21Sy19iqASdAOJeQ302Kb06ajsq+8SdfhCA==");
		public static VersionSign VER_WIN_3_5_0 { get; } = new VersionSign("3.5.0 [Build: 1584610661]", "Windows", ClientPlatform.Windows, "8um3guYdjDlKHOUZMYqt//4nT9k+SBYnAAP/9CarVp5pUXEzYaTZlflyOi6hjYIDn5cQ7gdvrKmdXLOXBJiqCA==");
		public static VersionSign VER_MAC_3_5_0 { get; } = new VersionSign("3.5.0 [Build: 1584610661]", "OS X", ClientPlatform.MacOs, "RZJrT/fysauFMv9ugB82ZAZN/t/MSWeJmFLu35FXx/r+3O1QZrM8rDfU5Iq/moG68hPRcc12KloOvrlVTdfiBg==");
		public static VersionSign VER_LIN_3_5_0 { get; } = new VersionSign("3.5.0 [Build: 1584610661]", "Linux", ClientPlatform.Linux, "kHfR/JyZ6Ah06rW/t+dFIHkOgLGFth5CCbRr9T3xfPd2gqL5CeYei47LGBjA9K9GrVVRivF0L5eo5MrxGh/QDA==");
		public static VersionSign VER_AND_3_5_0 { get; } = new VersionSign("3.5.0 [Build: 1582117478]", "Android", ClientPlatform.Android, "vASJQFPECG2TpUh5ATsR2c/gVrvsuZ9QlMpKN51F+HnanYNH3oCSGoievQX6ACjsKH3OZihNFQZ6f5HRU/MAAg==");
		public static VersionSign VER_IOS_3_5_0 { get; } = new VersionSign("3.5.0 [Build: 1574357871]", "iOS", ClientPlatform.Ios, "9m9E+yrIfJKmRDvujRH5IsbHXClEbgm9zRms+iL9ikLhiM1gzIBWBVVUKFqmtpSSZDq3lnmkN9DmaC8gxhvPBw==");
